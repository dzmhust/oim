...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="oimHouseholdPriceRule:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="oimHouseholdPriceRule:add">
						<td>
	       			...
	       			<shiro:hasPermission name="oimHouseholdPriceRule:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimHouseholdPriceRule:remove">
	       				<td>
						...
						<td>
	       				<span class="toolbar-item dialog-tool-separator"></span>
	       				       			...
	       				       			<shiro:hasPermission name="oimHouseholdPriceRule:enable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimHouseholdPriceRule:disable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimHouseholdPriceRule:setRegion">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/oimHouseholdPriceRuleList.js"></script>
</body>
</html>