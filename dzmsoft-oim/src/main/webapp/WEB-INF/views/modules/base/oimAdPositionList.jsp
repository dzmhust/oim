...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				<input type="text" name="filter_likes_name" class="easyui-textbox" data-options="width:150,prompt: '栏目名称'"/>
				<shiro:hasPermission name="oimAdPosition:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="oimAdPosition:add">
						<td>
	       			...
	       			<shiro:hasPermission name="oimAdPosition:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimAdPosition:remove">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/oimAdPositionList.js"></script>
</body>
</html>