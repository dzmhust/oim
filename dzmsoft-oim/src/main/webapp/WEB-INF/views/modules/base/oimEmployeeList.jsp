...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<input type="text" name="filter_likes_mobile" class="easyui-textbox" data-options="width:150,prompt: '手机号'"/>
				<shiro:hasPermission name="oimEmployee:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="oimEmployee:add">
						<td>
	       			...
	       			<shiro:hasPermission name="oimEmployee:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimEmployee:remove">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/oimEmployeeList.js"></script>
</body>
</html>