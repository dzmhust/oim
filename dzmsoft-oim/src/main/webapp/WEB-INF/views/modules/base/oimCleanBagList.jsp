...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="oimCleanBag:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="oimCleanBag:add">
						<td>
	       			...
	       			<shiro:hasPermission name="oimCleanBag:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimCleanBag:remove">
	       				<td>
						...
						<td>
	       				<span class="toolbar-item dialog-tool-separator"></span>
	       				       			...
	       				       			<shiro:hasPermission name="oimCleanBag:enable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimCleanBag:disable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimCleanBag:setRegion">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/oimCleanBagList.js"></script>
</body>
</html>