...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="oimMallCategory:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="oimMallCategory:add">
						<td>
	       			...
	       			<shiro:hasPermission name="oimMallCategory:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimMallCategory:remove">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/oimMallCategoryList.js"></script>
</body>
</html>