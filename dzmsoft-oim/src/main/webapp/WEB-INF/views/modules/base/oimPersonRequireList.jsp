...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="oimPersonRequire:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="oimPersonRequire:add">
						<td>
	       			...
	       			<shiro:hasPermission name="oimPersonRequire:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimPersonRequire:remove">
	       				<td>
						...
						<td>
	       				<span class="toolbar-item dialog-tool-separator"></span>
	       				       			...
	       				       			<shiro:hasPermission name="oimPersonRequire:enable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimPersonRequire:disable">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimPersonRequire:setRegion">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/oimPersonRequireList.js"></script>
</body>
</html>