...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="oimCard:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="oimCard:add">
						<td>
	       			...
	       			<shiro:hasPermission name="oimCard:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimCard:remove">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/base/oimCardList.js"></script>
</body>
</html>