...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="oimPaymentBill:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="oimPaymentBill:add">
						<td>
	       			...
	       			<shiro:hasPermission name="oimPaymentBill:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimPaymentBill:remove">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/finance/oimPaymentBillList.js"></script>
</body>
</html>