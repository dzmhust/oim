...
<div id="tb" style="padding:5px;height:auto">
        <div>
        	<form id="searchFrom" action="">
				...
				<shiro:hasPermission name="oimRecipientBill:find">
			...
			<table cellpadding="0" cellspacing="0">
				<tr>
					<shiro:hasPermission name="oimRecipientBill:add">
						<td>
	       			...
	       			<shiro:hasPermission name="oimRecipientBill:edit">
	       				<td>
	       			...
	       			<shiro:hasPermission name="oimRecipientBill:remove">
	       				<td>
...
<table id="dg"></table> 
<div id="dlg"></div>  
<script src="${ctxResources}/pages/modules/finance/oimRecipientBillList.js"></script>
</body>
</html>